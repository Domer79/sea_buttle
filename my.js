...
var mydefault_1 = __webpack_require__(9);
var table_1 = __webpack_require__(10);
var referee_1 = __webpack_require__(24);
var home;
(function (home) {
    mydefault_1.default();
    var t1 = new table_1.default();
    var t2 = new table_1.default();
    var referee = new referee_1.default(t1, t2);
    t1.render();
    t2.render();
    referee.play();
...
var ButtleField = function () {
    function ButtleField() {
        (0, _classCallCheck3.default)(this, ButtleField);
    ...
    (0, _createClass3.default)(ButtleField, [{
        key: "addHeadRow",
        value: function addHeadRow() {
            var row = $("<tr class=\"headRow\"></tr>");
            for (var i = 0; i < 11; i++) {
                if (i === 0) {
        ...
        value: function render() {
            var jqueryElement = $("<table class=\"" + this.addClasses() + "\"></table>");
            ...
            for (var r = 0; r < 10; r++) {
                ...
                for (var c = 0; c < 11; c++) {
                    ...
                    var $td = $("<td class=\"cell\" coords=\"" + (r + 1) + "," + c + "\"></td>").bind("shut", this.shut).on("click", function (event) {
                        var coords = $(this).attr("coords").split(',');
                        $(this).trigger({ type: "shut", "coords": coords });
                    });
                    row.append($td);
                    var fieldCell = new FieldCell(r + 1, c, this.fieldCells, $td);
        ...
        key: "defaultShut",
        value: function defaultShut(row, col) {
            var fieldCell = this.fieldCells.find(function (element) {
                return element.row === row && element.col === col;
            });
            fieldCell.removeMask();
            var ship = fieldCell.ship;
            if (!ship) {
        ...
        value: function initShips() {
            for (var i = 0; i < this.ships.length; i++) {
                var ships = this.ships.filter(function (element) {
                    return !element.ready;
                });
                var nextRandomShipIndex = Math.round(ships.length * Math.random());
                nextRandomShipIndex = ships.length === nextRandomShipIndex ? nextRandomShipIndex - 1 : nextRandomShipIndex;
                var ship = ships[nextRandomShipIndex];
                this.initShip(ship);
            }
        }
    }, {
        key: "initShip",
        value: function initShip(ship) {
            var freeCells = this.getFreeCells();
            var fieldCell = this.getFirstRandomCell(freeCells);
            var index = 0;
            while (true) {
            ...
            ship.occupy();
            this.fieldCells.forEach(function (element) {
        ...
        key: "getFirstRandomCell",
        value: function getFirstRandomCell(cells) {
            var rand = Math.random();
            var index = Math.round(rand * (cells.length * 0.5));
...
var FieldCell = function () {
    function FieldCell(r, c, allCells, td) {
        (0, _classCallCheck3.default)(this, FieldCell);
    ...
    (0, _createClass3.default)(FieldCell, [{
        key: "getNextCell",
        value: function getNextCell() {
            ...
            if (nextCell.cellStatus !== CellStatus.None) return undefined;
            return nextCell;
        }
    }, {
        key: "occupy",
        value: function occupy(ship) {
            this.ship = ship;
            this.workAround(function (fieldCells) {
                fieldCells.forEach(function (element) {
                    if (element && (element.cellStatus === CellStatus.None || element.cellStatus === CellStatus.Temp)) element.cellStatus = CellStatus.Occupy;
                });
            });
        }
    }, {
        ...
        key: "occupyRemoveMask",
        value: function occupyRemoveMask() {
            this.workAround(function (fieldCells) {
                fieldCells.forEach(function (element) {
                    if (element && (element.cellStatus === CellStatus.Occupy || element.cellStatus === CellStatus.Past)) element.td.removeClass("mask");
                });
            });
        }
    }, {
        key: "workAround",
        value: function workAround(work) {
            var leftCell = this.getCell(this.row, this.col - 1);
            var leftTopCell = this.getCell(this.row - 1, this.col - 1);
            var leftBottomCell = this.getCell(this.row + 1, this.col - 1);
            var rightCell = this.getCell(this.row, this.col + 1);
            var rightTopCell = this.getCell(this.row - 1, this.col + 1);
            var rightBottomCell = this.getCell(this.row + 1, this.col + 1);
            var topCell = this.getCell(this.row - 1, this.col);
            var bottomCell = this.getCell(this.row + 1, this.col);
            work([leftCell, leftTopCell, leftBottomCell, rightCell, rightTopCell, rightBottomCell, topCell, bottomCell]);
        }
    }, {
        key: "row",
        get: function get() {
        ...
        set: function set(value) {
            ...
            this.td.removeClass(Services.EnumToArray(CellStatus).join(' ').toLowerCase()).addClass(CellStatus[value].toLowerCase());
        }
    }]);
    return FieldCell;
}();
...
var Ship = function () {
    ...
    (0, _createClass3.default)(Ship, [{
        ...
        value: function SetTemp() {
            this.coords.forEach(function (element) {
                if (element) element.cellStatus = CellStatus.Temp;
            });
        }
    }, {
        key: "isReady",
        ...
        value: function occupy() {
            ...
            this.coords.forEach(function (element) {
                element.occupy(_this);
            });
        }
    }, {
        key: "isDead",
        value: function isDead() {
            return this.coords.filter(function (element) {
...
var Services = function () {
    ...
    (0, _createClass3.default)(Services, null, [{
        key: "EnumToArray",
        value: function EnumToArray(enumType) {
            var enums = new Array();
...
var Referee = function () {
    function Referee(userButtle, enemyButtle) {
        (0, _classCallCheck3.default)(this, Referee);
    ...
    (0, _createClass3.default)(Referee, [{
        key: "play",
        value: function play() {
        ...
        key: "initUserShut",
        value: function initUserShut() {
            var self = this;
            var userShut = function userShut(event) {
                var coords = event.coords;
                var row = coords[0] * 1;
                var col = coords[1] * 1;
                var cellStatus = self.enemyButtle.defaultShut(row, col);
            };
